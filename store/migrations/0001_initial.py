# Generated by Django 5.0.7 on 2024-10-27 20:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Paid'), ('U', 'unpaid'), ('C', 'canceld')], default='U', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('W', 'Waiting'), ('A', 'Approved'), ('NA', 'Not approved')], default='W', max_length=3)),
